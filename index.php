...
<body>
    ...
    <header class="hero">
        <div class="hero-content">
            ...
            <p>Join a vibrant community of food enthusiasts. Discover recipes, share your kitchen triumphs, and elevate
                your home cooking.</p>
    ...
    <?php if (!isset($_SESSION['user_id'])): // Only render the modal if they aren't logged in ?>
        <div id="joinModal" class="modal" style="align-items: center; justify-content: center;">
            <div class="modal-content premium-modal">
                <div class="premium-modal-image">
                    <img src="https://images.unsplash.com/photo-1495521821757-a1efb6729352?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80"
                        alt="Delicious Food">
                    <div class="premium-modal-overlay">
                        <h3>Join Our Culinary Family</h3>
                        <p>Unlock exclusive recipes, expert tutorials, and connect with thousands of food lovers today.</p>
                    </div>
                </div>
                <div class="premium-modal-form">
                    <span class="close-btn" style="top: 20px; right: 25px; z-index: 10;">&times;</span>
                    <h2
                        style="font-family: var(--font-heading); color: var(--primary-color); font-size: 1.8rem; margin-bottom: 5px;">
                        Welcome!</h2>
                    <p style="margin-bottom: 25px; color: #666; font-size: 0.95rem;">Create your free account to start
                        sharing recipes.</p>
                    <form id="registerForm" action="register_process.php" method="POST">
                        <div id="modalAlert" class="alert" style="display: none; margin-bottom: 15px;"></div>
                        <div class="form-group" style="margin-bottom: 15px;">
                            <input type="text" name="first_name" placeholder="First Name" required
                                style="margin: 0; padding: 12px; border-radius: 8px;">
                        ...
                        <button type="submit" class="btn primary-btn full-width"
                            style="margin-top: 5px; border-radius: 30px; font-weight: 600; padding: 14px; font-size: 1.05rem; box-shadow: 0 4px 15px rgba(230, 57, 70, 0.3);">Sign
                            Up Now</button>
                        <p style="margin-top: 20px; font-size: 0.9em; text-align: center;">
                            Already have an account? <a href="login.php"
                                style="color: var(--primary-color); font-weight: 600; text-decoration: none;">Log in
                                here</a>
                        </p>
                    </form>
                </div>
                ...
                while ($row = $featured_result->fetch_assoc()) {
                    ...
                    <div class="card"
                        ...
                        <div class="card-content" style="padding: 20px;">
                            <h3
                                style="color: var(--primary-color); margin-bottom: 10px; font-family: var(--font-heading); font-size: 1.25rem;">
                                <?php echo htmlspecialchars($row['title']); ?>
                            </h3>
                            <p style="color: var(--text-dark); font-size: 0.95rem; line-height: 1.6; margin-bottom: 15px;">
                                <?php echo $snippet; ?>
                            </p>
                            <a href="view_recipe.php?id=<?php echo $row['recipe_id']; ?>"
                                style="color: var(--text-dark); font-weight: 600; text-decoration: none; font-size: 0.9rem;">
                                Read Recipe &rarr;
                            </a>
                        </div>
                    </div>
        ...
        <div class="carousel-container">
            ...
            <div class="carousel-track">
                ...
                <div class="carousel-slide">
                    <div class="event-box">
                        <img src="https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?ixlib=rb-1.2.1&auto=format&fit=crop&w=1000&q=80"
                            alt="French Sauces" class="event-image">
                        <div class="event-details">
                            <h3>Mastering French Sauces</h3>
                            <p>Online Workshop</p>
                            <div class="countdown-timer" data-date="2026-06-15T10:00:00"></div>
                            <button class="btn outline-btn"
                                style="margin-top: 15px; padding: 5px 15px; font-size: 0.9em;"
                                onclick="registerForEvent('Mastering French Sauces')">Register Now</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="carousel-slide">
                    <div class="event-box">
                        <img src="https://images.unsplash.com/photo-1509440159596-0249088772ff?ixlib=rb-1.2.1&auto=format&fit=crop&w=1000&q=80"
                            alt="Sourdough" class="event-image">
                        <div class="event-details">
                            ...
                            <button class="btn outline-btn"
                                style="margin-top: 15px; padding: 5px 15px; font-size: 0.9em;"
                                onclick="registerForEvent('Sourdough for Beginners')">Register Now</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="carousel-slide">
                    <div class="event-box">
                        <img src="https://images.unsplash.com/photo-1596040033229-a9821ebd058d?ixlib=rb-1.2.1&auto=format&fit=crop&w=1000&q=80"
                            alt="Spices" class="event-image">
                        <div class="event-details">
                            ...
                            <button class="btn outline-btn"
                                style="margin-top: 15px; padding: 5px 15px; font-size: 0.9em;"
                                onclick="registerForEvent('Global Spices Masterclass')">Register Now</button>
                        </div>
                    </div>
                </div>
    ...
    <footer class="site-footer">
        <div class="footer-content" style="align-items: center;">
            <div class="footer-logo" style="display: flex; align-items: center; margin-bottom: 20px;"><img
                    src="assets/logo.png" alt="FoodFusion Logo"
                    style="height: 65px; width: auto; filter: drop-shadow(0px 2px 4px rgba(0,0,0,0.2));"></div>
    ...
    <div id="eventFormModal" class="modal" style="display: none; align-items: center; justify-content: center;">
        <div class="modal-content"
            style="max-width: 400px; padding: 35px 30px; border-radius: 12px; box-shadow: 0 10px 30px rgba(0,0,0,0.15);">
            <span class="close-btn" onclick="document.getElementById('eventFormModal').style.display='none'"
                style="position: absolute; top: 15px; right: 20px; font-size: 24px; cursor: pointer;">&times;</span>
            <h2
                style="margin-bottom: 5px; font-family: var(--font-heading); color: var(--text-dark); text-align: center;">
                Registration</h2>
            <h4 id="formEventNameDisplay"
                style="text-align: center; color: var(--primary-color); margin-bottom: 25px; font-size: 1.1em; font-weight: normal;">
            </h4>

            <form id="eventRegistrationForm">
                <input type="hidden" name="event_name" id="hiddenEventName">
                <div class="form-group" style="margin-bottom: 15px;">
                    <input type="text" name="username" placeholder="Pick a Username" class="form-control"
                ...
                <button type="submit" id="submitEventBtn" class="btn primary-btn"
                    style="width: 100%; border-radius: 50px; font-weight: 600; font-size: 1.1em; padding: 12px; cursor: pointer;">Complete
                    Registration</button>
            </form>
        </div>
    </div>
    ...
    <div id="eventModal" class="modal" style="display: none; align-items: center; justify-content: center;">
        <div class="modal-content"
            style="text-align: center; max-width: 400px; padding: 35px 30px; border-radius: 12px; box-shadow: 0 10px 30px rgba(0,0,0,0.15);">
            <span class="close-btn" onclick="document.getElementById('eventModal').style.display='none'"
                style="position: absolute; top: 15px; right: 20px; font-size: 24px; cursor: pointer;">&times;</span>
            <div id="eventModalIcon" style="font-size: 54px; color: #28a745; margin-bottom: 20px; line-height: 1;">
                &#10004;</div>
            <h2 id="eventModalTitle"
                style="margin-bottom: 15px; font-family: var(--font-heading); color: var(--text-dark);">Registered!</h2>
            <p id="eventModalMessage" style="color: #555; line-height: 1.6; margin-bottom: 25px; font-size: 1.05em;">You
                have successfully registered for the event.</p>
            <button class="btn primary-btn"
                style="width: 100%; border-radius: 50px; font-weight: 600; font-size: 1.1em; padding: 12px;"
                onclick="document.getElementById('eventModal').style.display='none'">Awesome!</button>
        </div>
    </div>

    <div id="cookieConsent" class="cookie-banner" style="display: none;">
        <div class="cookie-content">
            <p>We use cookies to improve your experience, serve personalized recipes, and analyze site traffic. By
                clicking "Accept All", you agree to our use of cookies.</p>
