                    ...
                    <div class="card recipe-card">
                        ...
                        <div class="card-content" style="padding: 20px; flex-grow: 1; display: flex; flex-direction: column;">
                            ...
                            <div class="badges" style="margin-bottom: 15px; display: flex; flex-wrap: wrap; gap: 8px;">
                                <span
                                    style="background: #f0f4f8; color: #475569; padding: 4px 10px; border-radius: 20px; font-size: 0.75rem; text-transform: uppercase; font-weight: 700;">
                                    <?php echo htmlspecialchars($row['cuisine_type']); ?>
                                </span>
                                <span
                                    style="background: #ecfdf5; color: #059669; padding: 4px 10px; border-radius: 20px; font-size: 0.75rem; text-transform: uppercase; font-weight: 700;">
                                    <?php echo htmlspecialchars($row['dietary_preference']); ?>
                                </span>
                                <span
                                    style="background: #fef2f2; color: #dc2626; padding: 4px 10px; border-radius: 20px; font-size: 0.75rem; text-transform: uppercase; font-weight: 700;">
                                    <?php echo htmlspecialchars($row['difficulty_level']); ?>
                                </span>
                            </div>

                            <h3
                                style="color: var(--primary-color); margin-bottom: 10px; font-family: var(--font-heading); font-size: 1.3rem;">
                                <?php echo htmlspecialchars($row['title']); ?>
                            </h3>

                            <p
                                style="color: var(--text-dark); font-size: 0.95rem; line-height: 1.6; margin-bottom: 20px; flex-grow: 1;">
                                <?php echo $snippet; ?>
                            </p>

                            <a href="view_recipe.php?id=<?php echo $row['recipe_id']; ?>" class="btn primary-btn full-width"
