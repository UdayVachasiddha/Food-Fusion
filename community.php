...
<body>
    ...
    <header class="hero recipe-hero"
        style="background-image: linear-gradient(rgba(29, 53, 87, 0.7), rgba(29, 53, 87, 0.7)), url('https://images.unsplash.com/photo-1547592180-85f173990554?ixlib=rb-1.2.1&auto=format&fit=crop&w=1950&q=80');">
    ...
    <section class="submission-section">
        <div class="form-container">
            ...
            <?php else: ?>
                <div class="login-prompt">
                    ...
                    <button id="triggerLoginModal" class="btn outline-btn"
                        onclick="document.getElementById('joinModal').style.display='flex'">Log In / Sign Up</button>
                </div>
            <?php endif; ?>
        </div>
        ...
        <div class="community-feed" style="max-width: 1200px; margin: 4rem auto; padding: 0 20px;">
            <h2
                style="text-align: center; margin-bottom: 2rem; font-family: var(--font-heading); color: var(--primary-color);">
                Latest from the Community</h2>
            ...
            <?php if ($feed_result && $feed_result->num_rows > 0): ?>
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 25px;">
                    ...
                    <?php while ($post = $feed_result->fetch_assoc()): ?>
                        <div class="post-card"
                            style="background: #fff; padding: 25px; border-radius: 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.05); border-top: 5px solid var(--primary-color); display: flex; flex-direction: column;">

                            <div style="margin-bottom: 15px;">
                                <span
                                    style="background: #fef2f2; color: #dc2626; padding: 4px 12px; border-radius: 20px; font-size: 0.75rem; font-weight: 700; text-transform: uppercase; display: inline-block; margin-bottom: 10px;">
                            ...
                            <h3
                                style="margin-bottom: 15px; font-size: 1.25rem; color: var(--text-dark); font-family: var(--font-heading);">
                                <?php echo htmlspecialchars($post['title']); ?>
                            </h3>

                            <p
                                style="color: #444; line-height: 1.6; font-size: 0.95rem; margin-bottom: 20px; flex-grow: 1; display: -webkit-box; -webkit-line-clamp: 4; -webkit-box-orient: vertical; overflow: hidden; text-overflow: ellipsis;">
                ...
                <?php if ($total_posts > 3): ?>
                    <div style="text-align: center; margin-top: 3rem;">
                        <a href="all_community_posts.php" class="btn primary-btn"
                            style="padding: 12px 35px; border-radius: 50px; text-decoration: none; font-weight: 600; letter-spacing: 1px; text-transform: uppercase;">
        ...
        <form action="submit_post.php" method="POST" class="community-form">
            ...
            <div class="form-group">
                ...
                <input type="text" name="title" id="title" class="form-control"
                    placeholder="e.g., My Grandma's Lasagna OR How to dice an onion..." required>
            </div>
            ...
            <div class="form-group">
                ...
                <textarea name="content" id="content" rows="6" class="form-control"
                    placeholder="Share your recipe steps, your best kitchen hack, or a fun cooking story..."
                    required></textarea>
            </div>
                ...
                while ($row = $recipes_result->fetch_assoc()):
                    ...
                    <div class="card recipe-card">
                        <div class="card-content" style="border-top: 4px solid var(--primary-color);">
                            <p style="font-size: 0.8rem; color: #888; text-transform: uppercase;">By
                            ...
                            <div class="recipe-badges" style="margin: 10px 0;">
                                ...
                                <span
                                    class="badge badge-difficulty <?php echo strtolower($row['difficulty_level']); ?>"><?php echo htmlspecialchars($row['difficulty_level']); ?></span>
                            </div>

                            <p><?php echo htmlspecialchars($row['description']); ?></p>
                            <a href="view_recipe.php?id=<?php echo $row['recipe_id']; ?>" class="btn outline-btn full-width"
                                style="margin-top: 15px; text-align: center; display: block; text-decoration: none;">Read
                                More</a>
                        </div>
                    </div>
                <?php
    ...
    <footer class="site-footer">
        <div class="footer-content">
            <div class="footer-logo" style="display: flex; align-items: center; margin-bottom: 15px;"><img
    ...
    <div id="successModal" class="modal success-modal">
        <div class="modal-content">
            ...
            <button class="btn primary-btn close-modal-btn"
                style="width: 100%; border-radius: 50px; padding: 12px;">Great!</button>
        </div>
    </div>
